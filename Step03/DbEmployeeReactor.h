...
//-----------------------------------------------------------------------------
//----- DbEmployeeReactor.h : Declaration of the DbEmployeeReactor
//-----------------------------------------------------------------------------
#pragma once
...
class /*DLLIMPEXP*/ DbEmployeeReactor : public AcDbDatabaseReactor {

public:
	ACRX_DECLARE_MEMBERS(DbEmployeeReactor);
...
public:
	DbEmployeeReactor(AcDbDatabase* pDb = NULL);
	virtual ~DbEmployeeReactor();
